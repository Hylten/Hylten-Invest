# Kan man lita på en AI‑agent med företagets ekonomi?
...
### Långsiktiga sekretessrisker Ekonomiska data är inte branschhemligheter.
...
Minimal datadelning AI‑agenten bör endast ges exakt den information som krävs för uppgiften.
...
Rolldefinition Agenten ska ha tydligt definierade och avgränsade roller.
