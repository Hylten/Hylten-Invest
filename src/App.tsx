      ...
      <BrowserRouter basename="/Hylten-Invest">
        <div className="min-h-screen bg-white">
          ...
          <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-50">
            <a
              href="/Hylten-Invest/"
              className="px-6 py-2 bg-white/80 backdrop-blur-md border border-black/10 text-black text-[10px] tracking-[0.3em] uppercase hover:bg-black hover:text-white transition-all duration-300 shadow-lg font-medium"
            >
              Return Home
            </a>
          </div>
